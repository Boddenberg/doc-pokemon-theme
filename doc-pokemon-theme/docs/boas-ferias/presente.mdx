...
export const CouponCopy = ({ code }) => {
  ...
  return (
    <div className="coupon" role="group" aria-label="Cupom Zé Delivery">
  ...
  return (
    <div className="gate-wrap">
      <div className="gate-card" role="dialog" aria-modal="true" aria-labelledby="gate-title">
        ...
        <p className="gate-tip">Dica: é o nome do seu pokémon starter preferido 🐢</p>
      </div>
    </div>
  );
};
...
<PasswordGate>
  <div className="gift-shell">
    <div className="panel">
      <div className="badge-ze">🍻 Zé Delivery</div>
      <h1 className="title">boas férias, tech!</h1>
      <p className="subtitle">
        Pra começar o descanso do jeito certo: aqui vai um vale de <strong>R$100</strong> pra usar no app.
      </p>

      <CouponCopy code="IWEN8K7OABB274LPQOLSYQ3GA" />

      <p className="note">Cole o código no checkout do app Zé Delivery e aproveite. Se der qualquer coisa, me chama! 😄</p>
